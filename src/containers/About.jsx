...
function About() {
  return (
    <div id='about' className='flex justify-center bg-ocean min-h-[400px]'>
      <div className='px-12 mx-auto py-32'>
        <img src={require('../img/profile-modified.png')} alt='profile' className='mr-8 h-[376px] w-[376px] px-6 basis-1/3 md:float-left md:align-middle' />
